# Contributing to uaxiom

Thanks for your interest in contributing. uaxiom is built by [The Fire Dev LLC](https://thefiredev.com).
...
Use [GitHub Issues](https://github.com/thefiredev/axiom/issues). Include:
